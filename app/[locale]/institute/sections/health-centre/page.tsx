  ...
  return (
    <>
      ...
      <section className="container">
        ...
        <article className="flex max-md:flex-col">
          <Image
            alt={text.facilities.ambulance1}
            className="aspect-video w-full max-md:rounded-b md:order-first md:rounded-l"
            height={100}
            src={`https://nitkkr.ac.in/wp-content/uploads/2023/03/2.1.jpg`}
            width={100}
          />
          ...
          >
            <span className="mb-1 block">{text.facilities.ambulance1}</span>
            <span className="mb-1 block">{text.facilities.ambulance2}</span>
            <span className="mb-1 block">{text.facilities.ambulance3}</span>
            <span className="mb-1 block">{text.facilities.ambulanceTel}</span>
          </p>
        </article>
        ...
        <article className=" mt-12 flex max-md:flex-col">
          <p
            className={
              ' bg-neutral-50 p-2 font-sans text-lg max-md:rounded-t sm:p-3 md:w-full md:rounded-r md:p-8  '
            }
          >
            {text.facilities.opd}
          </p>
        ...
        <article className="mt-12 flex max-md:flex-col md:flex-row-reverse">
          <section className="md:h-auto md:w-1/2">
            <Image
              ...
              src="https://nitkkr.ac.in/wp-content/uploads/2023/03/1.1.jpg"
              width={300}
              height={300}
              className="aspect-video w-full max-md:rounded-b md:order-first md:rounded-l"
            />
          ...
          <p
            className={
              'p-2 font-sans text-lg max-md:rounded-t sm:p-3 md:w-full md:rounded-l md:p-8'
            }
          >
            {text.facilities.dental}
          </p>
        </article>
        ...
        <article className=" mt-12 flex max-md:flex-col">
          <section className="md:h-auto md:w-1/2">
            <Image
              ...
              className="aspect-video w-full max-md:rounded-b md:order-first md:rounded-l"
              height={25}
              src={`https://nitkkr.ac.in/wp-content/uploads/2023/03/1.2.jpg`}
              width={25}
            />
          </section>
          <p
        ...
        <article className="mt-12 flex max-md:flex-col md:flex-row-reverse">
          <section className="md:h-auto md:w-1/2">
            <Image
              ...
              className="aspect-video w-full max-md:rounded-b md:order-first md:rounded-l"
              height={25}
              src={`https://nitkkr.ac.in/wp-content/uploads/2023/03/1.3.jpg`}
              width={25}
            />
          </section>
          <p
        ...
        <article className="mt-12 flex max-md:flex-col">
          <section className="md:h-auto md:w-1/2">
            <Image
              ...
              className="aspect-video w-full max-md:rounded-b md:order-first md:rounded-l"
              height={25}
              src={`https://nitkkr.ac.in/wp-content/uploads/2023/03/1.4.jpg`}
              width={25}
            />
          </section>
          <p
        ...
        <article className="mt-12 flex max-md:flex-col md:flex-row-reverse">
          <section className="md:h-auto md:w-1/2">
            <Image
              ...
              className="aspect-video w-full max-md:rounded-b md:order-first md:rounded-l"
              height={25}
              src={`https://nitkkr.ac.in/wp-content/uploads/2023/03/1.6.jpg`}
              width={25}
            />
          </section>
          <p
        ...
        <article className="mt-12 flex max-md:flex-col">
          <section className="md:h-auto md:w-1/2">
            <Image
              alt={text.facilities.casualty1}
              className="aspect-video w-full max-md:rounded-b md:order-first md:rounded-l"
              height={25}
              src={`https://nitkkr.ac.in/wp-content/uploads/2023/03/56.7.jpg`}
              width={25}
            />
          </section>
          <p
          ...
          >
            <span className="mb-1 block">{text.facilities.casualty1}</span>
            <span className="mb-1 block">{text.facilities.casualty2}</span>
          </p>
        </article>
      </section>
      <section className="container">
      ...
      <section className="container">
        ...
        <article className="flex max-md:flex-col">
          <Image
            ...
            height={100}
            src={`https://nitkkr.ac.in/wp-content/uploads/2023/01/21-768x1001.jpg`}
            width={100}
          />
        </article>
      </section>
