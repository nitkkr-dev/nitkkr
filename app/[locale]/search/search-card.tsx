...
import { SearchLink } from './search-utils';
...
interface WebPageCard extends CardContentBase, link {
  content: string;
}

interface PeopleCard extends link {
  image: string;
  name: string;
  designation: string;
  email: string;
...
interface DocumentCard extends link {
  content: string;
}

interface EventCard extends link {
  image: string;
  heading: string;
  subHeading: string;
  location: string;
...
interface NewsCard extends CardContentBase, link {
  content: string;
  image?: string;
}

interface CourseCard extends CardContentBase, link {
  subHeading: string;
  programme: string;
  programmeDuration: string;
}

interface ClubCard extends CardContentBase, link {
  image: string;
  subHeading: string;
  delegation: { post: string; name: string }[];
}

interface PostionCard extends link {
  position: string;
  organisation: string;
  names: string[];
  email: string;
...
const SearchCard: React.FC<{ index: number; cardContent: CardContent }> = ({
  ...
  return (
    <SearchLink label={cardContent.label} value={cardContent.value}>
      {card()}
    </SearchLink>
  );
};
