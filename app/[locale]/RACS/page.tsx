...
const ResearchProposalFormsData = [
  ...
  <ImageHeader
    ...
    headings={[
      ...
      { label: text.tabs.regionalCoordinator, href: '#regionalCoordinator' },
      { label: text.tabs.researchProposalForms, href: '#researchProposalForms' },
...
<section id="regionalCoordinator" className="mt-20">
  ...
  <ul className="flex w-full flex-col items-center">
    <li className="flex w-[90%] max-w-3xl rounded-lg border border-primary-500 bg-neutral-50 p-1">
      ...
      <section className="xs:ml-3 ml-2 flex flex-col justify-center sm:ml-6 md:ml-8">
        <h2 className="xs:text-xl mb-0 text-lg font-medium text-red-600 sm:text-2xl md:text-3xl">
          {text.coordinator.name}
        </h2>

        <p className="xs:text-base text-sm text-gray-700 sm:text-xl">
        ...
        <div className="xs:space-y-1 mt-2 space-y-0.5 sm:space-y-2">
          <span className="flex items-center">
            ...
            <a
              ...
              className="ml-2 text-gray-700 hover:text-primary-700 hover:underline"
            >
  ...
  <div className="grid grid-cols-1 items-center gap-8 md:grid-cols-2">
    ...
    <div className="relative overflow-hidden rounded-lg shadow-md">
      ...
      <div className="absolute bottom-0 left-0 right-0 z-10 h-2/3 bg-gradient-to-t from-black to-transparent"></div>

      {/* Read more overlay */}
      <Link
  href={text.researchAreas.link}
  className="absolute bottom-4 left-4 z-20 !text-white font-serif text-2xl font-semibold [text-shadow:0_2px_8px_rgba(0,0,0,0.8)] hover:underline"
>
