      ...
      <main className="container">
        ...
        <article className="container flex drop-shadow max-md:flex-col">
          <Link
            ...
            className="group relative w-full max-md:h-64 md:order-first md:rounded-l"
            style={{
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-t from-neutral-800/90 via-transparent to-transparent"></div>
        ...
        <article className="container flex drop-shadow max-md:flex-col">
          ...
          <Link
            ...
            className="group relative w-full max-md:h-64 max-md:rounded-bl max-md:rounded-tl md:order-first"
            style={{
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-t from-neutral-800/90 to-transparent"></div>
            <h4 className="absolute bottom-5 left-5 text-background transition-colors duration-300 ease-in-out group-hover:text-primary-500">
