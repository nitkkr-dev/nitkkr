...
Saturdays & Holidays: 09.00 am to 05.00 pm`,
    ...
    Security: {
      ...
      article: [
        ...
        'Security staff is provided with dedicated vehicles like Gypsy and Bi-cycles to carry out patrolling on and off campus. The staff looks after the perimeter, gates, static posts, & patrolling of the campus.Mobile Security Control Room, which is operational 24 hours a day, utilizes a number of technologies to decrease response times to calls for service and increase the effectiveness of the campus security personnel',
      ],
      aspects: {
        technologies: {
          title: 'TECHNOLOGIES',
          ...
          liaison:
            'Security Section maintains a close liaison with local emergency services like Police, Fire Brigade and Hospitals.',
        },
        ...
        securityandsupport: {
          ...
          content: [
            ...
            'Do not hesitate to call upon us for assistance whenever you have a concern for your safety and security. Remember, preventing crime is a shared responsibility between NIT Security Section and the community it serves.',
          ],
          features: [],
          liaison: '',
        },
