...
शनिवार और अवकाश: सुबह 09:00 से शाम 05:00 बजे तक`,
    ...
    HealthCentre: {},
    Security: {
      title: 'सुरक्षा अनुभाग',
      article: [
        'एनआईटी, कुरुक्षेत्र सुरक्षा अनुभाग सुरक्षा, अपराध जागरूकता, और निवासियों को अपराध का शिकार होने की संभावना को कम करने के लिए निवारक उपायों पर उपयोगी जानकारी प्रदान करता है।',

        'एनआईटी, कुरुक्षेत्र सुरक्षा, अजीत सिंह यादव, सुरक्षा अधिकारी के निर्देशन में काम करती है। इसमें 01 सुरक्षा गार्ड (स्थायी स्टाफ), 04 सुरक्षा पर्यवेक्षक, 11 हथियारबंद सुरक्षा गार्ड, 123 सुरक्षा गार्ड और 01 सीसीटीवी नियंत्रण कक्ष ऑपरेटर शामिल हैं, जिन्हें डायमंड सिक्योरिटी पर्सनेल से आउटसोर्सिंग आधार पर नियुक्त किया गया है।',

        'कैम्पस सुरक्षा स्टाफ के सदस्य उच्च प्रशिक्षित पेशेवर और सैन्य पृष्ठभूमि से हैं। उन्हें परिसर में प्रशिक्षण दिया जाता है, जिसमें सुरक्षा अनुभाग का दैनिक संचालन, सांस्कृतिक विविधता, यौन उत्पीड़न, एंटी-रैगिंग, विभिन्न घटनाओं और दुर्घटनाओं से निपटने की प्रक्रिया, प्राथमिक चिकित्सा, आग की रोकथाम और अग्निशमन, कार्यक्रम सुरक्षा, सामुदायिक पुलिसिंग और अपराध रोकथाम शामिल हैं।',

        'सुरक्षा कर्मचारियों को गश्त करने के लिए समर्पित वाहन जैसे जिप्सी और साइकिल प्रदान किए गए हैं। कर्मचारी परिसर के परिधि, गेट, स्थैतिक पोस्ट और गश्ती कार्यों की देखभाल करते हैं। मोबाइल सुरक्षा नियंत्रण कक्ष, जो 24 घंटे संचालन में रहता है, सेवा कॉल्स के लिए प्रतिक्रिया समय को कम करने और परिसर सुरक्षा कर्मियों की प्रभावशीलता बढ़ाने के लिए कई तकनीकों का उपयोग करता है।',
      ],
      aspects: {
        technologies: {
          title: 'प्रौद्योगिकियां',
          content1:
            'संस्थान का परिसर अच्छी तरह से सुरक्षित है और इसे बाउंड्री वॉल्स और सीसीटीवी कैमरों से घेरा गया है। प्रत्येक प्रवेश द्वार पर सुरक्षा गार्ड मौजूद होते हैं, जो परिसर में प्रवेश करने वाले सभी वाहनों की जांच करते हैं। परिसर के अंदर, कई सुरक्षा बूथ सख्त निगरानी रखते हैं।',
          features: [
            'वायरलेस संचार',
            'परिसर और नियंत्रण कक्ष में सुरक्षा अधिकारियों की चौबीसों घंटे उपलब्धता, जो परिसर की गतिविधियों की निगरानी करते हैं।',
            'एनआईटी, कुरुक्षेत्र में छात्रों, कर्मचारियों और संस्थान की संपत्ति की सुरक्षा सुनिश्चित करने के लिए 67 सीसीटीवी कैमरे लगाए गए हैं।',
          ],
          liaison:
            'सुरक्षा अनुभाग स्थानीय आपातकालीन सेवाओं जैसे पुलिस, अग्निशमन और अस्पतालों के साथ करीबी संबंध बनाए रखता है।',
        },
        securityandsupport: {
          title: 'सुरक्षा और समर्थन',
          content: [
            'सामुदायिक आधारित दृष्टिकोण अपनाते हुए, सुरक्षा अनुभाग अपराध को रोकने, पीड़ितों की सहायता प्रदान करने और अन्य परिसर अधिकारियों और शहर, राज्य और केंद्रीय कानून प्रवर्तन एजेंसियों के साथ मिलकर रिपोर्ट की गई घटनाओं की जांच करने का प्रयास करता है। यह कार्य अन्य सेवा उन्मुख विभागों जैसे वर्क्स और एनआईटी स्वास्थ्य केंद्र के साथ मिलकर करता है ताकि छात्रों, शिक्षकों और कर्मचारियों को एक सुरक्षित और सुरक्षित वातावरण प्रदान किया जा सके, जिसमें वे शैक्षणिक और सामाजिक अनुभवों का आनंद ले सकें।',

            'सुरक्षा अनुभाग हर साल एनआईटी, कुरुक्षेत्र में शामिल होने वाले नए छात्रों को उनके ओरिएंटेशन सत्र के माध्यम से सुरक्षा और सुरक्षा जागरूकता प्रशिक्षण प्रदान करता है।',

            'सुरक्षा अनुभाग के सभी सदस्य आपको परिसर में स्वागत करते हैं और एनआईटी, कुरुक्षेत्र परिसर में आपके प्रवास के दौरान शुभकामनाएं देते हैं। हम यहां आपकी सुरक्षा और सुखद अनुभव सुनिश्चित करने में मदद करने के लिए हैं।',

            'जब भी आपको अपनी सुरक्षा और सुरक्षा को लेकर कोई चिंता हो, तो हमसे सहायता लेने में संकोच न करें। याद रखें, अपराध को रोकना एनआईटी सुरक्षा अनुभाग और समुदाय की साझा जिम्मेदारी है।',
          ],
          features: [],
          liaison: '',
        },
