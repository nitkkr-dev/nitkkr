        ...
        <fieldset
          className={cn(
            ...
            (type === 'checkbox' || type === 'radio' || type === 'range') &&
              'inline-flex space-x-2 space-y-1'
          )}
        >
          {label &&
            type !== 'checkbox' &&
          ...
          <input
            ...
            className={cn(
              ...
              (type === 'checkbox' || type === 'radio') &&
                'h-4 w-4 shrink-0 appearance-none rounded-sm border border-primary-500 bg-shade-light checked:border-0 checked:bg-primary-500', //incomplete
              className
            )}
            onBlur={(event) => {
