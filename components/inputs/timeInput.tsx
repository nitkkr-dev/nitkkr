...
import { Dialog, DialogTrigger, DialogContent, DialogFooter, DialogHeader, DialogTitle, DialogClose } from '../ui/dialog';
...
export function TimeInput(props: TimeInputProps) {
    ...
    const isValidTime = (hours: number | null, minutes: number | null): boolean => {
            ...
            <DialogTrigger asChild>
                ...
                >
                    ...
                    {(hours !== null && minutes !== null) ? (
                        <time dateTime={`${hours}:${minutes}`}>{`${hours}:${minutes}`}</time>
